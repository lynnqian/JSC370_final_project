...
Here, we want to see if `Installs` and `Reviews` can both be used to represent popularity of the app by comparing them using the following line graph. 
...
This is a line plot with all the categories of the apps involved and combined with `Reviews`, and we want to see if there is any patterns between `Category` of the app and its `Rating`.
